...
<html>
    <head>
        <title>Crea Juegos Android - LOMUCHACHOgames</title>
...
<div class="dios">
            <form enctype="multipart/form-data" action="../includes/uploadgame.php" method="post" name="f1">
                <div class="row todo">
                    <?php
                    if (isset($error)) {
                        echo $error;
                    ...
                    <div class="col-md-10">
                        <div class="parte">
                            ...
                            <input name="creador" class="form-control" type="text" placeholder="Mojang, Rockstar o etc..."></div>
                            <div class="col-md-6">
                    ...
                    <div class="col-md-2" id="public">
                        ...
                        <div class="custom-control custom-checkbox"><br>
                            <input type="checkbox" class="custom-control-input" id="customCheck1"  name="categoria1" value="accion">
                            <label class="custom-control-label" >Accion</label><br>
                            <input type="checkbox" class="custom-control-input" id="customCheck1" name="categoria2" value="aventura">
                            <label class="custom-control-label"   >Aventura</label><br>
                            <input type="checkbox" class="custom-control-input" id="customCheck1" name="categoria3" value="estrategia">
                            <label class="custom-control-label" >Estrategia</label><br>
                            <input type="checkbox" class="custom-control-input" id="customCheck1" name="categoria4" value="casual">
                            <label class="custom-control-label"  >Casual</label><br>
                            <input type="checkbox" class="custom-control-input" id="customCheck1"  name="categoria5" value="simulacion">
                            <label class="custom-control-label" >Simulacion</label><br>
                            <input type="checkbox" class="custom-control-input" id="customCheck1" name="categoria6" value="Hack">
                            <label class="custom-control-label" >Hack</label><br>
                            <input type="checkbox" class="custom-control-input" id="customCheck1" value="deportes" name="categoria7">
                            <label class="custom-control-label">Deportes</label><br>
                        </div>
                        </div></div>
                        <div class="parte padding_dos">
                            <div class="insides">
