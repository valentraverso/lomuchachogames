...
<title>Estas viendo todos los juegos de LOMUCHACHOgames.com</title>
<meta name="googlebot" content="noindex">
...
<div class="dios">
    ...
    <h2 style="float:left">Juegos y Apps</h2><button class="btn btn-success"style="font-size:15px;float:left;margin-top:2px;margin-left:30px;"><a href="https://lomuchachogames.com/admin/apps.php?pagina=1">Apps</a></button><input style="width:40%;float:right;"  type="text" class="form-control" id="form"><button type="button" id="boton" style="float:right;" class="btn btn-warning">Buscar</button></div>';
    ?>
            </div>
              <div class="paginacion">
            <?php 
            $pagina = $_GET['pagina'];
$request = "SELECT COUNT(*) as todo FROM juegos";
...
if($final >= 0){
    for ($i=1;$i<=$final;$i++){ 
        ...
        echo "<p class=\"pag\" style=\"text-decoration: underline;\">".$pagina . "</p> "
            ...
            echo "<p class=\"pag\"><a href='https://lomuchachogames.com/admin/juegos.php?pagina=" . $i . "'>" . $i . "</a></p>"; 
        }
        }
}
            ?>
...
$menor = $pagina -1;
$pag = $menor * 50;
$result = "SELECT * FROM juegos WHERE status = '0' ORDER BY juegos.id DESC limit $pag,50";
$data = $conn->query($result);
while($fila = mysqli_fetch_array($data)){
echo '            
<a target="_blank" rel="nofollow" href="' . $fila['link'] . '">
 ...
 <span>' . $fila['id'] . '    
        ...
        <div class="infobusca" style="margin-left:115px;">
            ...
            <div class="botones">
            <form method="GET" action="../admin/edit" enctype="multipart/form-data" >
            ...
            <input type="submit" value="Editar" class="btn btn-outline-primary"><br>
               ...
               <form method="GET" action="../includes/delete.php" enctype="multipart/form-data" >
            <input type="text" name="name" value="' . $fila['nombre'] . '" style="display:none;">
...
?>
 ...
 <span>${producto.id}</span>    
        ...
        <div class="imgbusca" style="margin-left:10px;width:70px;height:70px;">
        ...
        <div class="infobusca" style="margin-left:115px;width:300;">
            ...
            <div class="botones">
            <form method="GET" action="../admin/edit.php" enctype="multipart/form-data" >
