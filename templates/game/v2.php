...
<script data-cfasync="false" type="text/javascript" src="//greatdexchange.com/a/display.php?r=6043818"></script>
  ...
  echo'  <script data-cfasync="false" type="text/javascript" src="//greatdexchange.com/a/display.php?r=6043798"></script></div>
    <div class="report">
    ...
    '.$texto.'
    </div><div class="row about sg">
    <h3 style="font-size:17px"><i class="fa fa-arrow-right"></i> Juega mejor con esto...</h3>
    <iframe sandbox="allow-popups allow-scripts allow-modals allow-forms allow-same-origin" style="width:80%;height:240px;" marginwidth="0" marginheight="0" scrolling="no" frameborder="0" src="//rcm-eu.amazon-adsystem.com/e/cm?lt1=_blank&bc1=000000&IS2=1&bg1=FFFFFF&fc1=000000&lc1=0000FF&t=eltraver-21&language=es_ES&o=30&p=8&l=as4&m=amazon&f=ifr&ref=as_ss_li_til&asins=B07P8D1MXH&linkId=dd955f5a3d4781a5a497275aa8d54d6b"></iframe>
</div>';
...
include_once $_SERVER['DOCUMENT_ROOT'].'/templates/sliders/games/juegosrandomgame.php';
include_once $_SERVER['DOCUMENT_ROOT'].'/templates/sliders/games/mismacat.php';
echo '<div class="row about">
    ...
    <p style="font-size:12px;">LOMUCHACHOgames respeta los derechos de propiedad intelectual de terceros, al hacer click en los botones de descarga te estas saliendo del sitio https://lomuchachogames.com.</p>
</div>
</div></div>';
