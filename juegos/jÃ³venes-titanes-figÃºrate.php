...
$info = "<p><strong>Jóvenes titanes Figúrate</strong> APK + OBB para Android es una gran opcion a la hora de elegir ente estos juegos. Algunas características de este son:</p><ul><li>DESAFÍA A TUS AMIGOS</li><li>MÁS DE 90 FIGURAS PARA COLECCIONAR</li><li>PERSONALIZA TU EQUIPO</li></ul>";
$versiondispositivo = "5.1 o +";
$edad = "+10";
$title = "Descarga Jóvenes titanes Figúrate APK + OBB GRATIS para Android full.";
$description = "Descarga Jóvenes titanes Figúrate APK + OBB GRATIS para Android APK full. Jóvenes titanes Figúrate gratis y sin virus para Android.";
$key = "Jóvenes titanes Figúrate, Jóvenes titanes Figúrate APK + OBB, Titans, Jóvenes titanes GRATIS, Jóvenes titanes Android, Descargar Jóvenes titanes Figúrate,";
$tags = '<b>Accion</b>';
