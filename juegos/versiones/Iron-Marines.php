...
$select = "SELECT * FROM juegos WHERE nombre = 'Iron Marines'";
...
$titulopagina =  "Todas las versiones de Iron Marinespara Android - Descargar Iron Marines ultima version";
 echo'
    <!DOCTYPE html>
<html>
    <head>
...
echo '
            <meta name="description" content="Descarga la ultima version de Iron Marines gratis para Android, o tambien podes descargar versiones anteriores. Iron Marines Android, descargar Iron Marines y todas sus versiones."/> 
            <meta name="keywords" content="Iron Marines, descargar Iron Marines,"></head>
    <body>';
