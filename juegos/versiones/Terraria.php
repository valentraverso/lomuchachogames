...
$select = "SELECT * FROM juegos WHERE nombre = 'Terraria'";
...
$titulopagina =  "Todas las versiones de Terrariapara Android - Descargar Terraria ultima version";
 echo'
    <!DOCTYPE html>
<html>
    <head>
...
echo '
            <meta name="description" content="Descarga la ultima version de Terraria gratis para Android, o tambien podes descargar versiones anteriores. Terraria Android, descargar Terraria y todas sus versiones."/> 
            <meta name="keywords" content="Terraria, descargar Terraria,"></head>
    <body>';
