...
<p>Descargar <strong>LEGO® El Señor de los Anillos™</strong> apk + obb gratis para Android en LOMUCHACHOgames y salava a la tierra.</p>";
 echo'
    <!DOCTYPE html>
<html>
    <head>
...
echo '<title>Descargar LEGO El señor de Los Anillos APK + OBB gratis para Android </title><meta name="description" content="Descargar LEGO El señor de Los Anillos APK + OBB gratis para Android '.$version.' full en español, LEGO para Android GRATIS libre de virus ultima version.  "/> <meta name="keywords" content="Lego: el señor de los añillos, LEGO android, juegos para android,"></head>
    <body>';
...
<div class="container-fluid">
    ...
    <div class="row" id="buttond">
        <div class="col-xs-6">
               <a target="_blank" rel="external nofollow" href="http://download1127.mediafire.com/4is2dv882f5g/9t8baev9l8hi916/LEGOESDLAbyLOMUCHACHOgames.apk" id="mediafireapk">APK Mediafire</a>
        </div>
        <div class="col-xs-6">
            <a target="_blank" rel="external nofollow" href="http://evassmat.com/18932179/legoesdlaapkmega" id="megaapk"?id=X>APK Mega</a>
        </div>
        <div class="col-xs-6">
            <a target="_blank" style="margin-top:5px;" rel="external nofollow" href="http://download1339.mediafire.com/2wcbzhii5d2g/124hmw4qjwr57bc/LEGOESDLAbyLOMUCHACHOgames.zip" id="mediafireapk">OBB Mediafire</a>
