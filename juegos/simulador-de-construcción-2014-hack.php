...
$select = "SELECT * FROM juegos WHERE nombre = 'Simulador de Construcción 2014 HACK'";
...
<p>Descargar <strong>Simulador de Construcción 2014 HACK </strong>para Android APK + OBB gratis en LOMUCHACHOgames y construye lo que mas quieras.</p>";
 echo'
    <!DOCTYPE html>
<html>
    <head>
...
echo '<title>Descarga Simulador de Construcción 2014 HACK GRATIS para Android</title><meta name="description" content="Descarga Simulador de Construcción 2014 HACK GRATIS para Android en todas sus versiones en LOMUCHACHOgames.com"/> <meta name="keywords" content="Simulador de Construcción 2014 HACK, astragon Entertainment GmbH, Android,"></head>
    <body>';
...
<div class="container-fluid">
    <div class="row" >
        ...
        <div class="col-xs-8" id="principal3s">
            ...
            <div class="tags">
                <a href="hthttps://lomuchachogames.com/juegos/categorias/accion.php"><b>Accion</a></b><a href="https://lomuchachogames.com/juegos/categorias/aventura.php"><b>Aventura</a></b><a href="https://lomuchachogames.com/juegos/categorias/simulacion.php"><b>Simulacion</a></b><a href="https://lomuchachogames.com/juegos/categorias/rol.php"><b>Rol</a></b> </div>
    ...
    <div class="row" id="buttond">
        <div class="col-xs-6">
               <a target="_blank" rel="external nofollow" href="http://evassmat.com/18932179/sc2014-1-12-hackapk" id="mediafireapk">APK Mediafire</a>
        </div>
        <div class="col-xs-6">
            <a target="_blank" rel="external nofollow" href="http://evassmat.com/18932179/sc2014-1-12-hackapkmega" id="megaapk"?id=X>APK Mega</a>
        </div>
        <div class="col-xs-6">
 ...
 <p>Simulador de Construcción 2014 HACK APK + OBB para Android es una gran opcion a la hora de elegir ente estos juegos. Algunas características de este son:</p>
<ul>
