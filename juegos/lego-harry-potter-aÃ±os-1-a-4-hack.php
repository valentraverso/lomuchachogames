...
<p>Descargar<strong> LEGO Harry Potter: años 1 a 4 HACK </strong>apk + obb gratis para Android en LOMUCHACHOgames y se el mejor mago.</p>";
$info = "<p>LEGO Harry Potter: años 1 a 4 HACK para Android es una gran opcion a la hora de elegir ente juegos de aventura. Algunas características de este son:</p>
<ul>
 	<li> MOD del juego</li>
</ul>";
 echo'
...
echo '<title>Descarga LEGO Harry Potter: años 1 a 4 HACK GRATIS para Android</title><meta name="description" content="Descarga LEGO Harry Potter: años 1 a 4 HACK GRATIS para Android en todas sus versiones en LOMUCHACHOgames.com"/> <meta name="keywords" content="LEGO Harry Potter: años 1 a 4 HACK, Warner Bros. International Enterprises, Android,"></head>
    <body>';
...
<div class="container-fluid">
    ...
    <div class="row" id="buttond">
        <div class="col-xs-6">
               <a target="_blank" rel="external nofollow" href="http://download939.mediafire.com/jdpq1tnqvgcg/1ckz7lafl8omga2/LEGOHPA14HACKbyLOMUCHACHOgames.apk" id="mediafireapk">APK Mediafire</a>
        </div>
        <div class="col-xs-6">
            <a target="_blank" rel="external nofollow" href="http://evassmat.com/18932179/legohpa14hackapkmega" id="megaapk"?id=X>APK Mega</a>
        </div>
        <div class="col-xs-6">
