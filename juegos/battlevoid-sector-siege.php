...
$select = "SELECT * FROM juegos WHERE nombre = 'Battlevoid: Sector Siege'";
...
<p>Descargar<strong> Battlevoid: Sector Siege </strong>apk gratis para Android en LOMUCHACHOgames y defiendete de los enemigos.</p>";
