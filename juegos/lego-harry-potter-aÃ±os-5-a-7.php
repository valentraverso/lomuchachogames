...
<p>Descargar<strong> LEGO Harry Potter: años 5 a 7 </strong>apk + obb gratis para Android en LOMUCHACHOgames y se el mejor mago.</p>";
$info = "<p>LEGO Harry Potter: años 5 a 7 para Android es una gran opcion a la hora de elegir ente juegos de aventura. Algunas características de este son:</p>
<ul>
...
echo '<title>Descarga LEGO Harry Potter: años 5 a 7 GRATIS para Android</title><meta name="description" content="Descarga LEGO Harry Potter: años 5 a 7 GRATIS para Android en todas sus versiones en LOMUCHACHOgames.com"/> <meta name="keywords" content="LEGO Harry Potter: años 5 a 7, Warner Bros. International Enterprises, Android,"></head>
    <body>';
...
<div class="container-fluid">
    ...
    <div class="row" id="buttond">
        <div class="col-xs-6">
               <a target="_blank" rel="external nofollow" href="http://download1501.mediafire.com/4ev3a0c8a4wg/pby4cdbghscgqn3/LEGOHPA57byLOMUCHACHOgames.apk" id="mediafireapk">APK Mediafire</a>
        </div>
        <div class="col-xs-6">
            <a target="_blank" rel="external nofollow" href="http://evassmat.com/18932179/legohpa57apk" id="megaapk"?id=X>APK Mega</a>
        </div>
        <div class="col-xs-6">
            <a target="_blank" style="margin-top:5px;" rel="external nofollow" href="http://download1035.mediafire.com/17abo68gldcg/3qg20e8117hhclw/LEGOHPA57byLOMUCHACHOgames.zip" id="mediafireapk">OBB Mediafire</a>
        </div><div class="col-xs-6">
            <a target="_blank" style="margin-top:5px;"  rel="external nofollow" href="http://evassmat.com/18932179/legohpa57obbmega" id="megaapk">OBB Mega</a>
        </div>
    </div>';
